...
export function showMigrationModal(shadowRoot, migrationInfo) {
  ...
  // 마이그레이션 기능은 현재 비활성화되어 있으므로 버튼은 비활성화
  confirmBtn.disabled = true;
  confirmBtn.title = '마이그레이션은 현재 비활성화되어 있습니다.';
  ...
  confirmBtn.addEventListener('click', () => {
    ...
    // run_data_migration은 백엔드에서 비활성화됨. 사용자에게 알림만 표시.
    showToast('❌ 마이그레이션 기능은 현재 비활성화되어 있습니다. 추후 다시 제공 예정입니다.');
  });
