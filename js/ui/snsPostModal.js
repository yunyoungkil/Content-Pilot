...
export async function showSnsPostModal(platform, title, url, itemId, container) {
  ...
  modal.style.cssText = 'position: fixed !important; top: 0 !important; left: 0 !important; width: 100% !important; height: 100% !important; background: rgba(0, 0, 0, 0.8) !important; display: flex !important; align-items: center !important; justify-content: center !important; z-index: 2147483647 !important;';
  modal.innerHTML = `
  ...
  console.log('[SNS Post] Modal appended to:', targetRoot === document.body ? 'document.body' : 'Shadow Root');
